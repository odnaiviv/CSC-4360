...
-- function to allow ship to fire laser 
...
-- function to allow user to drag ship across screen 
...
-- function to continuously loop game 
local function gameLoop()
    -- new asteroid 
	createAsteroid()

    -- removes off screen asteroids 
...
-- function to restore ship when dead 
